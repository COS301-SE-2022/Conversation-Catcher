...
describe('UserManagementFeatureResolver', () => {
  ...
  //     expect(await resolver.addUser('testEmail')).toEqual(userObj);
  //   });
  // });
  // // async addUser(@Args('email') email: string)
  // describe('getUser', () => {
  //   it('If a valid email is given it should return the user', async () => {
  //     expect(await resolver.getUser('testEmail')).toEqual(userObj);
  //   });
  //   it('If an invalid email is given it should return an error object', async () => {
  //     expect(await resolver.addUser('wrongEmail')).toEqual(errorObj);
  //   });
  // });
  // // async getUser(@Args('email') email: string)

  // describe('setUser', () => {
  //   it('Should return true if the user was succesfully set',async () => {
  //     expect(await resolver.setUser('testEmail','testEmail','#ff00',[])).toBeTruthy();
  //   });
  // });
  // // async setUser(
  ...
  // describe('deleteUser', () => {
  //   it('Should return true if the user was succesfully set', async () => {
  //     expect(await resolver.deleteUser('testEmail')).toBeTruthy();
  //   });
  // });
